...
public class CategoryServiceImpl implements CategoryService {
    ...
    @Override
    @Cacheable(value = "CategoryServiceImpl::findByName", key = "#name")
    ...
    @Caching(
            put = {
                    @CachePut(value = "CategoryServiceImpl::findByName", key = "#category.name")
            }
    )
    @Transactional
    ...
    @Override
    @Cacheable(value = "CategoryServiceImpl::findById", key = "#id")
